      ...
      <ul className="inline-flex items-stretch -space-x-px">
        ...
        {paginationNumbers.map((num) => (
          <li onClick={() => paginate(num)} key={num}>
            <a
              href="#"
              className={`flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ${currentPage === num ? 'dark:bg-gray-800':'dark:bg-gray-900'} dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white`}
            >
              {num}
            </a>
          </li>
